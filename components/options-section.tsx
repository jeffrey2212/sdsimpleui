          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button
                ...
                onClick={(e) => {
                  console.log("Configure button clicked", e)
                  // Don't stop propagation as the DialogTrigger needs to receive the event
                }}
              >
            ...
            <DialogContent className="bg-gemini-card border-gemini-border p-4 sm:max-w-[425px]">
